...
const HeroSection = () => {
  return (
    <div className="relative mb-[1x]  overflow-hidden before:content-[''] sm:mt-[-20px] mt-[-30px] before:absolute before:top-0 before:left-1/2 before:-translate-x-1/2 before:w-full before:h-full before:bg-no-repeat before:bg-top before:-z-10 ">
      <Arabian />
